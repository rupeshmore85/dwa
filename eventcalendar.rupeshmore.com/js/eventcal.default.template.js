		...
		Web2Cal.defaultPlugins.load=function(opts)
		{
			...
			var createNewEventTemplate = function()
			{
				var _html='<div id="defaultNewEventTemplate" class="calendarTemplate newEventTemplate">	'
							...
							+'				<div class="value">	'
							+'					<textarea  class="inputbox" rows="2" cols="20" name="eventName" id="eventName"></textarea>'
							+'				</div>	'
							+'			</div> 	'
							...
							+'				<div class="value">	'
							+'					<textarea  class="inputbox" rows="4" cols="20" name="eventDescription" id="eventDescription" autocomplete="off"></textarea>'
							+'				</div>	'
							+'			</div> 	'
